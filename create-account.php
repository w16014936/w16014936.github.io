            ...
            <form onsubmit="" action="signupProcess.php" id="signUpForm" class="form" name="signupForm" method="POST">
                ...
                <div class="formPage1" id="formPage1">
                	<div class="form-group">
                    	<input type="text" id="signUp-username" class="form-control" placeholder="Username" name="username" />
                        <p id="usernameValidationMsg" class="formPage1 formErrorMessages" style="display: none"></p>
                	</div>
                	<div class="form-group">
                    	<input type="password" id="signUp-pass" class="form-control" placeholder="Password" name="password" />
                        <p id="passwordValidationMsg" class="formPage1 formErrorMessages" style="display: none">Passwords must be matching &#10008</p>
                	</div>
                	<div class="form-group">
                    	<input type="password" id="signUp-confirmPass" class="form-control" placeholder="Confirm Password" name="confirmPassword" />
                	</div>
                ...
                <div class="formPage2" id="formPage2" style="display: none">
                	...
                	<div class="form-group">
                    	<input type="text" id="signUp-forename" class="form-control" placeholder="Forename" name="forename" />
                        <p id="forenameValidationMsg" class="formPage2 formErrorMessages" style="display: none"></p>
                	</div>
                	<div class="form-group">
                    	<input type="text" id="signUp-surname" class="form-control" placeholder="Surname" name="surname" />
                           <p id="surnameValidationMsg" class="formPage2 formErrorMessages" style="display: none"></p>
                	</div>
                	<div class="form-group">
                    	<input type="date" id="signUp-dateOfBirth" class="form-control" placeholder="Date of Birth" name="dateOfBirth" />
                        <p id="DOBValidationMsg" class="formPage2 formErrorMessages" style="display: none"></p>
                	</div>
                	<div class="form-group">
                    	<input type="text" id="signUp-email" class="form-control" placeholder="Email Address" name="email" />
                        <p id="emailValidationMsg" class="formPage2 formErrorMessages" style="display: none"></p>
                	</div>
                	<div class="form-group">
                    	<input type="number" id="signUp-phone" class="form-control" placeholder="Phone Number" name="phone" />
				...
				<div class="formPage3" id="formPage3" style="display: none">
                	<div class="form-group">
                    	<input type="text" id="signUp-address1" class="form-control" placeholder="Address Line 1" name="address1" />
                        <p id="address1ValidationMsg" class="formPage3 formErrorMessages" style="display: none"></p>
               		</div>
                	<div class="form-group">
                    	<input type="text" id="signUp-address2" class="form-control" placeholder="Address Line 2 (Optional)" name="address2" />
                	</div>
                	<div class="form-group">
                    	<input type="text" id="signUp-address3" class="form-control" placeholder="Address Line 3 (Optional)" name="address3" />
                	</div>
                	<div class="form-group">
                    	<input type="text" id="signUp-address4" class="form-control" placeholder="Address Line 4 (Optional)"  name="address4" />
                	</div>
                	<div class="form-group">
                    	<input type="text" id="signUp-address5" class="form-control" placeholder="Address Line 5 (Optional)" name="address5" />
                	</div>
                	<div class="form-group">
                    	<input type="text" id="signUp-postcode" class="form-control" placeholder="Post Code" name="postcode" />
                ...
                <div class="formPage4" id="formPage4" style="display:none">
               		...
               		<div class="form-group">
                    	<input type="number" min="0" id="contractedHours" class="form-control" placeholder="Contracted Hours" name="contractedHours" />
