...
if(isset($_REQUEST['activity_id'])){
    ...
    if(is_numeric($_REQUEST['activity_id'])){
        if(!empty(getActivity($dbConn, $_REQUEST['activity_id']))){
            ...
            $errorText = "You have not chosen a valid activity to delete.  Please select an actvity <a href='manage-activity.php'>here</a> to remove it from the system";
    ...
    if (isset($errorText)){
      ...
      if (empty($errors)){
        ...
        if (deleteActivity($dbConn, $input)){
          $deleteSuccess = "<h3>You have successfully deleted the activity. To update another please click <a href='manage-activity.php'>here</a>.</h3>";
        }
