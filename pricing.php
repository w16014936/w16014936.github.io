  ...
  <div class="card-deck mb-3 text-center">
   <div class="card mb-4 shadow-sm">
     ...
     <div class="card-body">
       ...
       <button type="button" onclick="window.location.href='signup.php'" class="btn btn-lg btn-block btn-outline-primary">Sign up for free</button>
     </div>
   </div>
   <div class="card mb-4 shadow-sm">
     <div class="card-header">
     ...
     <div class="card-body">
       ...
       <button type="button" onclick="window.location.href='signup.php'" class="btn btn-lg btn-block btn-primary">Get started</button>
     </div>
   </div>
   <div class="card mb-4 shadow-sm">
     <div class="card-header">
