...
function getArchivedAccountsTable($dbConn, $loggedIn = null){
  ...
  <div class="row">
    ...
    if (isset($errorText)){
      echo "<p>$errorText</p>";
        ...
        echo $content = !empty(getArchivedAccountsTable($dbConn, $loggedIn)) ? getArchivedAccountsTable($dbConn, $loggedIn) : "<p class='no-results'>There are currently no accounts in the system.</p>";
